...
#import "WeiuiNavbarComponent.h"
#import "WeiuiNavbarItemComponent.h"
#import "UIImage+TBCityIconFont.h"
#import "WXComponent+Layout.h"
#import "WXComponent_internal.h"
#import "WXUtility.h"
#import "WeiuiIconComponent.h"
#import "DeviceUtil.h"

@interface WeiuiNavView : UIView

@end

@implementation WeiuiNavView

@end

@interface WeiuiNavbarComponent()
...
@implementation WeiuiNavbarComponent
...
- (UIView*)loadView
{
    return [[WeiuiNavView alloc] init];
}
...
- (void)insertSubview:(WXComponent *)subcomponent atIndex:(NSInteger)index
{
    ...
    if ([subcomponent isKindOfClass:[WeiuiNavbarItemComponent class]]) {
...
{
    WeiuiNavView *navView = (WeiuiNavView*)self.view;
    ...
    for (int i = 0; i< _subViews.count; i++) {
        WeiuiNavbarItemComponent *component = _subViews[i];
