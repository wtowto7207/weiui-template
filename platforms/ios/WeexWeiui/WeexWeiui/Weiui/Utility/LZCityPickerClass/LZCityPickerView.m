...
- (void)layoutSubviews {
    ...
    if (!self.autoChange) {
        ...
        self.cancelButton.frame = CGRectMake(10, 0, 40, lz_buttonHeight);
        
    }
    
    self.commitButton.frame = CGRectMake(lz_screenWidth - 50, 0, 40, lz_buttonHeight);
