 ...
 * {@link cc.weiui.framework.extend.integration.glide.GlideBuilder} and registering
 * {@link cc.weiui.framework.extend.integration.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, cc.weiui.framework.extend.integration.glide.load.ResourceDecoder)} for each
 * {@link cc.weiui.framework.extend.integration.glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * cc.weiui.framework.extend.integration.glide.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="cc.weiui.framework.extend.integration.glide.samples.flickr.FlickrGlideModule"
