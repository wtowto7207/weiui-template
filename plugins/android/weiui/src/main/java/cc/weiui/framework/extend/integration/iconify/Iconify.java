...
import cc.weiui.framework.extend.integration.iconify.internal.ParsingUtil;
...
public class Iconify {
     ...
     */
    public static IconFontDescriptorWrapper findTypefaceOf(cc.weiui.framework.extend.integration.iconify.Icon icon) {
     ...
     */
    public static cc.weiui.framework.extend.integration.iconify.Icon findIconForKey(String iconKey) {
        for (int i = 0, iconFontDescriptorsSize = iconFontDescriptors.size(); i < iconFontDescriptorsSize; i++) {
            ...
            cc.weiui.framework.extend.integration.iconify.Icon icon = iconFontDescriptor.getIcon(iconKey);
