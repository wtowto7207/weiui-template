package cc.weiui.framework.extend.integration.xutils.cache;
...
import cc.weiui.framework.extend.integration.xutils.common.util.MD5;
import cc.weiui.framework.extend.integration.xutils.common.util.ProcessLock;
import cc.weiui.framework.extend.integration.xutils.config.DbConfigs;
...
import cc.weiui.framework.extend.integration.xutils.ex.FileLockedException;
...
public final class LruDiskCache {
    ...
    public void clearCacheDb() {
        WhereBuilder whereBuilder = WhereBuilder.b("dirName", "=", cacheDirName);
        try {
