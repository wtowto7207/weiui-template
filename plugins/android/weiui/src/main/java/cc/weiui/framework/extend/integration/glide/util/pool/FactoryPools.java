package cc.weiui.framework.extend.integration.glide.util.pool;
 ...
 * created, and that can use the {@link cc.weiui.framework.extend.integration.glide.util.pool.FactoryPools.Poolable}
