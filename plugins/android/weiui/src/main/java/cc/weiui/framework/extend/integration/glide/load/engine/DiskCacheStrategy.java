...
public abstract class DiskCacheStrategy {
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.data.DataFetcher} and the
   * {@link cc.weiui.framework.extend.integration.glide.load.EncodeStrategy} of the
   * {@link cc.weiui.framework.extend.integration.glide.load.ResourceEncoder} (if an
   * {@link cc.weiui.framework.extend.integration.glide.load.ResourceEncoder} is available).
   */
   ...
   * cc.weiui.framework.extend.integration.glide.load.ResourceEncoder} will use to encode the resource.
   */
