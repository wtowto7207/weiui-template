...
import cc.weiui.framework.extend.integration.glide.load.ImageHeaderParser;
...
import cc.weiui.framework.extend.integration.glide.load.ResourceEncoder;
import cc.weiui.framework.extend.integration.glide.load.data.DataRewinder;
import cc.weiui.framework.extend.integration.glide.load.data.DataRewinderRegistry;
import cc.weiui.framework.extend.integration.glide.load.engine.DecodePath;
import cc.weiui.framework.extend.integration.glide.load.engine.LoadPath;
import cc.weiui.framework.extend.integration.glide.load.engine.Resource;
import cc.weiui.framework.extend.integration.glide.load.model.ModelLoader;
import cc.weiui.framework.extend.integration.glide.load.model.ModelLoaderFactory;
import cc.weiui.framework.extend.integration.glide.load.model.ModelLoaderRegistry;
import cc.weiui.framework.extend.integration.glide.load.resource.transcode.ResourceTranscoder;
import cc.weiui.framework.extend.integration.glide.load.resource.transcode.TranscoderRegistry;
import cc.weiui.framework.extend.integration.glide.provider.EncoderRegistry;
import cc.weiui.framework.extend.integration.glide.provider.ImageHeaderParserRegistry;
import cc.weiui.framework.extend.integration.glide.provider.LoadPathCache;
import cc.weiui.framework.extend.integration.glide.provider.ModelToResourceClassCache;
import cc.weiui.framework.extend.integration.glide.provider.ResourceDecoderRegistry;
import cc.weiui.framework.extend.integration.glide.provider.ResourceEncoderRegistry;
import cc.weiui.framework.extend.integration.glide.util.pool.FactoryPools;
...
public class Registry {
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.resource.gif.GifDrawable} etc).
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.resource.gif.GifDrawable} and any other subclass.
   *
  ...
  /**
   * Registers a new {@link cc.weiui.framework.extend.integration.glide.load.data.DataRewinder.Factory} to handle a
  ...
  /**
   * Thrown when no {@link cc.weiui.framework.extend.integration.glide.load.model.ModelLoader} is registered for a given
   * model class.
   */
