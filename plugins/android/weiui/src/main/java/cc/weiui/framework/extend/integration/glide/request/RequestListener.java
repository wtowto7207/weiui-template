...
public interface RequestListener<R> {
   ...
   * use {@link cc.weiui.framework.extend.integration.glide.RequestBuilder#error(RequestBuilder)} instead.
   *
   ...
   * Target#onResourceReady(Object, cc.weiui.framework.extend.integration.glide.request.transition.Transition)}.
   *
