...
import cc.weiui.framework.extend.integration.glide.GlideContext;
...
import cc.weiui.framework.extend.integration.glide.load.resource.drawable.DrawableDecoderCompat;
import cc.weiui.framework.extend.integration.glide.request.target.SizeReadyCallback;
...
import cc.weiui.framework.extend.integration.glide.request.transition.TransitionFactory;
...
import cc.weiui.framework.extend.integration.glide.util.pool.StateVerifier;

/**
 * A {@link Request} that loads a {@link cc.weiui.framework.extend.integration.glide.load.engine.Resource} into a given
 * {@link Target}.
 *
