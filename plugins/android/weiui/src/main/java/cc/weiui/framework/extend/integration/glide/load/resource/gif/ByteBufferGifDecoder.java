...
import cc.weiui.framework.extend.integration.glide.gifdecoder.GifHeader;
import cc.weiui.framework.extend.integration.glide.gifdecoder.GifHeaderParser;
import cc.weiui.framework.extend.integration.glide.gifdecoder.StandardGifDecoder;
...
import cc.weiui.framework.extend.integration.glide.load.resource.UnitTransformation;
...
/**
 * An {@link cc.weiui.framework.extend.integration.glide.load.ResourceDecoder} that decodes {@link
 * cc.weiui.framework.extend.integration.glide.load.resource.gif.GifDrawable} from {@link java.io.InputStream} data.
 */
