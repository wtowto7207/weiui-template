...
import cc.weiui.framework.extend.integration.glide.request.transition.NoTransition;
import cc.weiui.framework.extend.integration.glide.request.transition.TransitionFactory;
import cc.weiui.framework.extend.integration.glide.request.transition.ViewAnimationFactory;
import cc.weiui.framework.extend.integration.glide.request.transition.ViewPropertyAnimationFactory;
import cc.weiui.framework.extend.integration.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link cc.weiui.framework.extend.integration.glide.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * {@link cc.weiui.framework.extend.integration.glide.request.transition.Transition} for each request started with these
