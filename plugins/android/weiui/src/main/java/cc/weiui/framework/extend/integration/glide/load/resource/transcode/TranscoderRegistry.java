...
/**
 * A class that allows {@link cc.weiui.framework.extend.integration.glide.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link cc.weiui.framework.extend.integration.glide.load.resource.transcode.ResourceTranscoder} using
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
