...
import cc.weiui.framework.extend.integration.glide.load.data.AssetFileDescriptorLocalUriFetcher;
import cc.weiui.framework.extend.integration.glide.load.data.DataFetcher;
import cc.weiui.framework.extend.integration.glide.load.data.FileDescriptorLocalUriFetcher;
import cc.weiui.framework.extend.integration.glide.load.data.StreamLocalUriFetcher;
 ...
 * {@link cc.weiui.framework.extend.integration.glide.load.model.ModelLoader} that handles
 * {@link cc.weiui.framework.extend.integration.glide.load.model.GlideUrl}s.
 *
