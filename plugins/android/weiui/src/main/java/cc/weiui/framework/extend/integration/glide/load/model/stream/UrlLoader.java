 ...
 * cc.weiui.framework.extend.integration.glide.load.model.GlideUrl} objects and then uses the wrapped {@link
 * cc.weiui.framework.extend.integration.glide.load.model.ModelLoader} for {@link cc.weiui.framework.extend.integration.glide.load.model.GlideUrl}s to
 * load the data.
 */
