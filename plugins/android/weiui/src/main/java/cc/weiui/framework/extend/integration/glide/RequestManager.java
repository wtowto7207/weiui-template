...
import static cc.weiui.framework.extend.integration.glide.request.RequestOptions.decodeTypeOf;
...
import cc.weiui.framework.extend.integration.glide.manager.ConnectivityMonitor;
import cc.weiui.framework.extend.integration.glide.manager.ConnectivityMonitorFactory;
import cc.weiui.framework.extend.integration.glide.manager.Lifecycle;
import cc.weiui.framework.extend.integration.glide.manager.LifecycleListener;
import cc.weiui.framework.extend.integration.glide.manager.RequestManagerTreeNode;
import cc.weiui.framework.extend.integration.glide.manager.RequestTracker;
import cc.weiui.framework.extend.integration.glide.manager.TargetTracker;
...
public class RequestManager implements LifecycleListener,
   ...
   * cc.weiui.framework.extend.integration.glide.load.ResourceDecoder}s that can decode any subclass of {@link Drawable}.
   *
   ...
   * cc.weiui.framework.extend.integration.glide.load.engine.DiskCacheStrategy#DATA}. As a result, specifying a
   * {@link cc.weiui.framework.extend.integration.glide.load.engine.DiskCacheStrategy} on this request is generally not
   * recommended.
   *
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.ResourceDecoder}s
