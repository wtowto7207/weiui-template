package cc.weiui.framework.extend.module.rxtools.module.scaner;
...
import cc.weiui.framework.extend.integration.zxing.MultiFormatReader;
...
import cc.weiui.framework.extend.integration.zxing.common.HybridBinarizer;
...
final class DecodeHandler extends Handler {
    ...
    DecodeHandler(PageActivity activity) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(activity.getScanHandler(), R.id.decode_succeeded, rawResult);
            ...
            Message message = Message.obtain(activity.getScanHandler(), R.id.decode_failed);
            message.sendToTarget();
        }
    }
