...
/**
 * Generates {@link cc.weiui.framework.extend.integration.glide.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link cc.weiui.framework.extend.integration.glide.load.model.ModelLoader ModelLoaders} and the model
