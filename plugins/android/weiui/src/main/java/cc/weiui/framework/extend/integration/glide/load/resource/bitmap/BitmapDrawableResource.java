...
/**
 * A {@link cc.weiui.framework.extend.integration.glide.load.engine.Resource} that wraps an
 ...
 * given {@link cc.weiui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} when the resource is
 * recycled. </p>
 */
