...
/**
 * A request that loads a resource for an {@link cc.weiui.framework.extend.integration.glide.request.target.Target}.
 */
public interface Request {
   ...
   * {@link cc.weiui.framework.extend.integration.glide.request.target.Target}s (for example). Using a similar but different
