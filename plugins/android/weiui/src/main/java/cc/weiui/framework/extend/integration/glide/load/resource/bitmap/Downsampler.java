package cc.weiui.framework.extend.integration.glide.load.resource.bitmap;
...
import cc.weiui.framework.extend.integration.glide.load.ImageHeaderParser.ImageType;
import cc.weiui.framework.extend.integration.glide.load.ImageHeaderParserUtils;
...
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
import cc.weiui.framework.extend.integration.glide.util.LogTime;
...
public final class Downsampler {
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "cc.weiui.framework.extend.integration.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
   * Indicates the {@link cc.weiui.framework.extend.integration.glide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<DownsampleStrategy> DOWNSAMPLE_STRATEGY =
      Option.memory("cc.weiui.framework.extend.integration.glide.load.resource.bitmap.Downsampler.DownsampleStrategy",
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("cc.weiui.framework.extend.integration.glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
   ...
   * {@link cc.weiui.framework.extend.integration.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
   ...
   * provided  {@link cc.weiui.framework.extend.integration.glide.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match
