 ...
 *
 * @param <T> The type of the model the {@link cc.weiui.framework.extend.integration.glide.load.model.ModelLoader}s built by
 *            this factory can handle
 * @param <Y> The type of data the {@link cc.weiui.framework.extend.integration.glide.load.model.ModelLoader}s built by this
 *            factory can load.
 */
