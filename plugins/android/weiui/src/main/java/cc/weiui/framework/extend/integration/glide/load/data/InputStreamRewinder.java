...
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.RecyclableBufferedInputStream;
...
public final class InputStreamRewinder implements DataRewinder<InputStream> {
  ...
  /**
   * Factory for producing {@link cc.weiui.framework.extend.integration.glide.load.data.InputStreamRewinder}s from {@link
