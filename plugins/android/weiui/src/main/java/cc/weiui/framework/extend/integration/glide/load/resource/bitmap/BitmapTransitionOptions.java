...
import cc.weiui.framework.extend.integration.glide.TransitionOptions;
import cc.weiui.framework.extend.integration.glide.request.transition.BitmapTransitionFactory;
import cc.weiui.framework.extend.integration.glide.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions extends
   ...
   *
   * @see cc.weiui.framework.extend.integration.glide.GenericTransitionOptions#with(TransitionFactory)
   */
  @NonNull
   ...
   * @see cc.weiui.framework.extend.integration.glide.request.transition.DrawableCrossFadeFactory.Builder
   */
  @NonNull
