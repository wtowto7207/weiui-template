...
import cc.weiui.framework.extend.integration.glide.load.data.InputStreamRewinder;
import cc.weiui.framework.extend.integration.glide.load.engine.Engine;
import cc.weiui.framework.extend.integration.glide.load.engine.bitmap_recycle.ArrayPool;
import cc.weiui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool;
import cc.weiui.framework.extend.integration.glide.load.engine.cache.MemoryCache;
import cc.weiui.framework.extend.integration.glide.load.engine.prefill.BitmapPreFiller;
import cc.weiui.framework.extend.integration.glide.load.engine.prefill.PreFillType;
import cc.weiui.framework.extend.integration.glide.load.model.AssetUriLoader;
import cc.weiui.framework.extend.integration.glide.load.model.ByteArrayLoader;
import cc.weiui.framework.extend.integration.glide.load.model.ByteBufferEncoder;
import cc.weiui.framework.extend.integration.glide.load.model.ByteBufferFileLoader;
import cc.weiui.framework.extend.integration.glide.load.model.DataUrlLoader;
import cc.weiui.framework.extend.integration.glide.load.model.FileLoader;
import cc.weiui.framework.extend.integration.glide.load.model.GlideUrl;
import cc.weiui.framework.extend.integration.glide.load.model.MediaStoreFileLoader;
import cc.weiui.framework.extend.integration.glide.load.model.ResourceLoader;
import cc.weiui.framework.extend.integration.glide.load.model.StreamEncoder;
import cc.weiui.framework.extend.integration.glide.load.model.StringLoader;
import cc.weiui.framework.extend.integration.glide.load.model.UnitModelLoader;
import cc.weiui.framework.extend.integration.glide.load.model.UriLoader;
import cc.weiui.framework.extend.integration.glide.load.model.UrlUriLoader;
import cc.weiui.framework.extend.integration.glide.load.model.stream.HttpGlideUrlLoader;
import cc.weiui.framework.extend.integration.glide.load.model.stream.HttpUriLoader;
import cc.weiui.framework.extend.integration.glide.load.model.stream.MediaStoreImageThumbLoader;
import cc.weiui.framework.extend.integration.glide.load.model.stream.MediaStoreVideoThumbLoader;
import cc.weiui.framework.extend.integration.glide.load.model.stream.UrlLoader;
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.BitmapDrawableDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.BitmapDrawableEncoder;
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.BitmapEncoder;
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.DefaultImageHeaderParser;
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.Downsampler;
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.ResourceBitmapDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.StreamBitmapDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.UnitBitmapDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.bitmap.VideoDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.bytes.ByteBufferRewinder;
import cc.weiui.framework.extend.integration.glide.load.resource.drawable.ResourceDrawableDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.drawable.UnitDrawableDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.file.FileDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.gif.ByteBufferGifDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.gif.GifDrawable;
import cc.weiui.framework.extend.integration.glide.load.resource.gif.GifDrawableEncoder;
import cc.weiui.framework.extend.integration.glide.load.resource.gif.GifFrameResourceDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.gif.StreamGifDecoder;
import cc.weiui.framework.extend.integration.glide.load.resource.transcode.BitmapBytesTranscoder;
import cc.weiui.framework.extend.integration.glide.load.resource.transcode.BitmapDrawableTranscoder;
import cc.weiui.framework.extend.integration.glide.load.resource.transcode.DrawableBytesTranscoder;
import cc.weiui.framework.extend.integration.glide.load.resource.transcode.GifDrawableBytesTranscoder;
import cc.weiui.framework.extend.integration.glide.manager.ConnectivityMonitorFactory;
import cc.weiui.framework.extend.integration.glide.manager.RequestManagerRetriever;
import cc.weiui.framework.extend.integration.glide.module.ManifestParser;
import cc.weiui.framework.extend.integration.glide.request.RequestOptions;
import cc.weiui.framework.extend.integration.glide.request.target.ImageViewTargetFactory;
import cc.weiui.framework.extend.integration.glide.request.target.Target;
import cc.weiui.framework.extend.integration.glide.util.Preconditions;
import cc.weiui.framework.extend.integration.glide.util.Util;
import java.io.File;
 ...
 * {@link cc.weiui.framework.extend.integration.glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
  ...
  private static void initializeGlide(@NonNull Context context, @NonNull GlideBuilder builder) {
    ...
    List<cc.weiui.framework.extend.integration.glide.module.GlideModule> manifestModules = Collections.emptyList();
    ...
    if (annotationGeneratedModule != null
      ...
      Iterator<cc.weiui.framework.extend.integration.glide.module.GlideModule> iterator = manifestModules.iterator();
      while (iterator.hasNext()) {
        cc.weiui.framework.extend.integration.glide.module.GlideModule current = iterator.next();
    ...
    if (Log.isLoggable(TAG, Log.DEBUG)) {
      for (cc.weiui.framework.extend.integration.glide.module.GlideModule glideModule : manifestModules) {
    ...
    for (cc.weiui.framework.extend.integration.glide.module.GlideModule module : manifestModules) {
    ...
    try {
      Class<GeneratedAppGlideModule> clazz =
          (Class<GeneratedAppGlideModule>)
              Class.forName("cc.weiui.framework.extend.integration.glide.GeneratedAppGlideModuleImpl");
  ...
  /**
   * Returns the {@link cc.weiui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} used to
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.ResourceDecoder}s and
   * {@link cc.weiui.framework.extend.integration.glide.load.Transformation}s. Use outside of these classes is not generally
   * recommended. </p>
   */
  @NonNull
  ...
  /**
   * Pre-fills the {@link cc.weiui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} using the given
   * sizes.
   *
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool}. Rotation should be carefully
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.engine.prefill.PreFillType.Builder Builders} representing
