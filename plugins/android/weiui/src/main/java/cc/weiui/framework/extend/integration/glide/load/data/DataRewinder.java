...
public interface DataRewinder<T> {
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.data.DataRewinder}s.
   *
   * @param <T> The type of data that the {@link cc.weiui.framework.extend.integration.glide.load.data.DataRewinder} will
   *            wrap.
   */
  interface Factory<T> {
    /**
     * Returns a new {@link cc.weiui.framework.extend.integration.glide.load.data.DataRewinder} wrapping the given data.
     */
    @NonNull
     ...
     * {@link cc.weiui.framework.extend.integration.glide.load.data.DataRewinder}s for.
     */
    @NonNull
