package cc.weiui.framework.extend.integration.glide.provider;
...
import cc.weiui.framework.extend.integration.glide.load.resource.transcode.UnitTranscoder;
import cc.weiui.framework.extend.integration.glide.util.MultiClassKey;
import java.util.Collections;
import java.util.concurrent.atomic.AtomicReference;

/**
 * Maintains a cache of data, resource, and transcode classes to available
 * {@link cc.weiui.framework.extend.integration.glide.load.engine.LoadPath}s capable of decoding with the requested types.
 */
