...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
   ...
   * cc.weiui.framework.extend.integration.glide.request.Request}. </p>
   */
  @Override
  @Nullable
   ...
   *   on older versions, be sure to call {@link cc.weiui.framework.extend.integration.glide.RequestManager#clear(View)} on
