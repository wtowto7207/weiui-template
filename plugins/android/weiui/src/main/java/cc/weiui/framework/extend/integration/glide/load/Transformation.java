...
public interface Transformation<T> extends Key {
   ...
   * cc.weiui.framework.extend.integration.glide.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *                  cc.weiui.framework.extend.integration.glide.request.target.Target#SIZE_ORIGINAL} to indicate the
