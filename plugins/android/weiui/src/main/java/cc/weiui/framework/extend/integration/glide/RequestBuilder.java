...
import static cc.weiui.framework.extend.integration.glide.request.RequestOptions.diskCacheStrategyOf;
import static cc.weiui.framework.extend.integration.glide.request.RequestOptions.signatureOf;
import static cc.weiui.framework.extend.integration.glide.request.RequestOptions.skipMemoryCacheOf;
...
import cc.weiui.framework.extend.integration.glide.request.ErrorRequestCoordinator;
import cc.weiui.framework.extend.integration.glide.request.FutureTarget;
import cc.weiui.framework.extend.integration.glide.request.Request;
import cc.weiui.framework.extend.integration.glide.request.RequestCoordinator;
import cc.weiui.framework.extend.integration.glide.request.RequestFutureTarget;
...
import cc.weiui.framework.extend.integration.glide.request.SingleRequest;
import cc.weiui.framework.extend.integration.glide.request.ThumbnailRequestCoordinator;
import cc.weiui.framework.extend.integration.glide.request.target.PreloadTarget;
import cc.weiui.framework.extend.integration.glide.request.target.Target;
import cc.weiui.framework.extend.integration.glide.request.target.ViewTarget;
import cc.weiui.framework.extend.integration.glide.signature.ApplicationVersionSignature;
import cc.weiui.framework.extend.integration.glide.util.Preconditions;
import cc.weiui.framework.extend.integration.glide.util.Synthetic;
 ...
 * {@link cc.weiui.framework.extend.integration.glide.request.target.Target}.
 */
// Public API.
...
public class RequestBuilder<TranscodeType> implements Cloneable,
   ...
   * cc.weiui.framework.extend.integration.glide.load.model.ModelLoader}, {@link cc.weiui.framework.extend.integration.glide.load.ResourceDecoder},
   * and {@link cc.weiui.framework.extend.integration.glide.load.Transformation}s. However,
   * {@link cc.weiui.framework.extend.integration.glide.request.RequestOptions#placeholder(int)} and
   * {@link cc.weiui.framework.extend.integration.glide.request.RequestOptions#error(int)}, and
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.model.ModelLoader} or
   * {@link cc.weiui.framework.extend.integration.glide.load.ResourceDecoder} instead of using this method.
   *
   ...
   * {@link cc.weiui.framework.extend.integration.glide.request.RequestOptions#signature(cc.weiui.framework.extend.integration.glide.load.Key)} to
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.engine.DiskCacheStrategy#NONE} and/or
   * {@link cc.weiui.framework.extend.integration.glide.request.RequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
   ...
   * {@link cc.weiui.framework.extend.integration.glide.request.RequestOptions#signature(cc.weiui.framework.extend.integration.glide.load.Key)}
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link cc.weiui.framework.extend.integration.glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * using {@link cc.weiui.framework.extend.integration.glide.load.engine.DiskCacheStrategy#NONE} via
   * {@link RequestOptions#diskCacheStrategy(cc.weiui.framework.extend.integration.glide.load.engine.DiskCacheStrategy)}
   * during development, and re-enabling the default
   * {@link cc.weiui.framework.extend.integration.glide.load.engine.DiskCacheStrategy#RESOURCE} for release builds.
   *
   ...
   * {@link cc.weiui.framework.extend.integration.glide.load.Transformation}s to these {@link Drawable}s by either extracting
   ...
   * transformed (other than {@link cc.weiui.framework.extend.integration.glide.load.resource.gif.GifDrawable}). To avoid
   ...
   * method, especially in conjunction with {@link cc.weiui.framework.extend.integration.glide.load.Transformation}s with
   * caution for non-{@link Bitmap} {@link Drawable}s.
   *
   * @see #load(Integer)
   * @see cc.weiui.framework.extend.integration.glide.signature.ApplicationVersionSignature
   */
  @NonNull
  @CheckResult
  @Override
   ...
   * @return The
   * {@link cc.weiui.framework.extend.integration.glide.request.target.Target} used to wrap the given {@link ImageView}.
   */
  @NonNull
   ...
   *               overridden by
   *               {@link cc.weiui.framework.extend.integration.glide.request.RequestOptions#override(int, int)} if
   *               previously called.
   ...
   * @see cc.weiui.framework.extend.integration.glide.ListPreloader
   */
  @NonNull
