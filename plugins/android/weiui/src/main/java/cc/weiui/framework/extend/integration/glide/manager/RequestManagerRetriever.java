...
/**
 * A collection of static methods for creating new {@link cc.weiui.framework.extend.integration.glide.RequestManager}s or
 * retrieving existing ones from activities and fragment.
 */
public class RequestManagerRetriever implements Handler.Callback {
  @VisibleForTesting
  static final String FRAGMENT_TAG = "cc.weiui.framework.extend.integration.glide.manager";
