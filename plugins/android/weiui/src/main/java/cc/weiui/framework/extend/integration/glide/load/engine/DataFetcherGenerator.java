...
/**
 * Generates a series of {@link cc.weiui.framework.extend.integration.glide.load.data.DataFetcher DataFetchers} using
 * registered {@link cc.weiui.framework.extend.integration.glide.load.model.ModelLoader ModelLoaders} and a model.
 */
interface DataFetcherGenerator {
  /**
   * Called when the generator has finished loading data from a
   * {@link cc.weiui.framework.extend.integration.glide.load.data.DataFetcher}.
   */
  ...
  /**
   * Attempts to a single new {@link cc.weiui.framework.extend.integration.glide.load.data.DataFetcher} and returns true if
   * a {@link cc.weiui.framework.extend.integration.glide.load.data.DataFetcher} was started, and false otherwise.
   */
  boolean startNext();
