package cc.weiui.framework.extend.integration.iconify;
...
import cc.weiui.framework.extend.integration.iconify.internal.IconFontDescriptorWrapper;
...
public class IconDrawable extends Drawable {
    ...
    private cc.weiui.framework.extend.integration.iconify.Icon icon;
    ...
    public IconDrawable(Context context, String iconKey) {
        cc.weiui.framework.extend.integration.iconify.Icon icon = cc.weiui.framework.extend.integration.iconify.Iconify.findIconForKey(iconKey);
        if (icon == null) {
     ...
     */
    public IconDrawable(Context context, cc.weiui.framework.extend.integration.iconify.Icon icon) {
        init(context, icon);
    }

    private void init(Context context, cc.weiui.framework.extend.integration.iconify.Icon icon) {
