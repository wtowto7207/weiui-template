...
import cc.weiui.framework.extend.integration.glide.load.data.DataFetcher.DataCallback;
 ...
 * cc.weiui.framework.extend.integration.glide.load.engine.DataFetcherGenerator} implementations and should try to avoid this
 * duplication. </p>
 */
