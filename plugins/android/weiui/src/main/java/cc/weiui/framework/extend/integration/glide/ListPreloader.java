...
import cc.weiui.framework.extend.integration.glide.request.target.BaseTarget;
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  public interface PreloadModelProvider<U> {
     ...
     * {@link cc.weiui.framework.extend.integration.glide.request.RequestOptions#override(int, int)} to do so.
     *
  ...
  /**
   * Constructor for {@link cc.weiui.framework.extend.integration.glide.ListPreloader} that accepts interfaces for providing
